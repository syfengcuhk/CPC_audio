...
bs=64
PATH_CHECKPOINT_DIR=egs/librispeech/exp/train_clean_${train_size}_all_all_50000000_2GPU_bstune
#PATH_CHECKPOINT_DIR=egs/librispeech/exp/train_clean_${train_size}_all_all_50000000_4GPU
stop_epoch=200
source activate cpc_librilight
python cpc/train.py  --pathCheckpoint $PATH_CHECKPOINT_DIR  --nGPU ${nGPU} --n_process_loader 8  --batchSizeGPU ${bs} --stop_epoch $stop_epoch 
source deactivate
